...
class AppStyle {
  static TextStyle txtInterBold20WhiteA700d6 = TextStyle(
  ...
  static TextStyle txtInterBold20Black9009e = TextStyle(
    color: ColorConstant.black9009e,
    fontSize: getFontSize(
      20,
    ),
    fontFamily: 'Inter',
  ...
  static TextStyle txtInterExtraBold36 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      36,
    ),
  ...
  static TextStyle txtInterBold20WhiteA700 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      20,
    ),
  ...
  static TextStyle txtInterBold20Red300 = TextStyle(
